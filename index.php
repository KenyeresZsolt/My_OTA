...
$routes = [
    ...
    ['GET', '/csomagok/{pckSlug}/beallitasok/adatok' , 'editPackageHandler'],
    ['GET', '/csomagok/{pckSlug}/beallitasok/szolgaltatasok' , 'editServicesHandler'],
    ['GET', '/csomagok/{pckSlug}/beallitasok/kedvezmenyek' , 'editDiscountsHandler'],
    ['GET', '/csomagok/{pckSlug}/beallitasok/szobak' , 'editRoomsHandler'],
    ...
    ['POST', '/update-discounts/{pckId}' , 'updateDiscountsHandler'],
