                ...
                <div class="form-group">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div style="max-width: 10rem;">
                                <label for="capacity" class="form-label mt-4">Szobák száma</label>
                                <input class="form-control" type="text" name="capacity" autocomplete="off"/>                                        
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            ...
                            <div class="form-check" style="max-width: 8rem;">
                                ...
                                <input class="form-check-input" type="checkbox"  name="languages" value="HUN">
                                    magyar
                                </label>
                            </div>
                            <div class="form-check" style="max-width: 8rem;">
                                <label class="form-check-label" for="languages">
                                <input class="form-check-input" type="checkbox"  name="languages" value="ROM">
                                    román
                                </label>
                            </div>
                            <div class="form-check" style="max-width: 8rem;">
                                <label class="form-check-label" for="languages">
                                <input class="form-check-input" type="checkbox"  name="languages" value="ENG">
                                    angol
                                </label>
                            </div>
                            <div class="form-check" style="max-width: 8rem;">
                                <label class="form-check-label" for="languages">
                                <input class="form-check-input" type="checkbox"  name="languages" value="GER">
                                    német
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div style="max-width: 15rem;">
                                ...
                                <input class="form-control" type="text" name="postalCode" autocomplete="off"/>                                        
                            </div>
                        </div>
                        <div class="row">
                            <div style="max-width: 25rem;">
                                <label for="street" class="form-label mt-4">Utca</label>
                                <input class="form-control" type="text" name="street" autocomplete="off"/>                                        
                            </div>
                            ...
                            <div style="max-width: 8rem;">
                                ...
                                <input class="form-control" type="text" name="building" autocomplete="off"/>                                        
                            </div>
                            <div style="max-width: 8rem;">
                                <label for="floor" class="form-label mt-4">Emelet</label>
                                <input class="form-control" type="text" name="floor" autocomplete="off"/>                                        
                            </div>
                            <div style="max-width: 8rem;">
                                <label for="door" class="form-label mt-4">Ajtó</label>
                                <input class="form-control" type="text" name="door" autocomplete="off"/>                                        
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="container">
                        ...
                        <div class="row">
                            <div style="max-width: 15rem;">
                                ...
                                <input class="form-control" type="text" name="contactName" autocomplete="off"/>                                        
                            </div>
                            <div style="max-width: 15rem;">
                                <label for="contactEmail" class="form-label mt-4">Szállás emailcíme</label>
                                <input class="form-control" type="text" name="contactEmail" autocomplete="off"/>                                        
                            </div>
                            <div style="max-width: 15rem;">
                                <label for="contactPhone" class="form-label mt-4">Szállás telefonszáma</label>
                                <input class="form-control" type="text" name="contactPhone" autocomplete="off"/>                                        
                            </div>
                            <div style="max-width: 15rem;">
                                <label for="contactPage" class="form-label mt-4">Szállás honlapja</label>
                                <input class="form-control" type="text" name="contactPage" autocomplete="off"/>                                        
                            </div>
                        </div>
                    </div>
                    <hr>
